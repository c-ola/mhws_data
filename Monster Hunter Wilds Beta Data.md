...
The common/enemy directory contains tons of data about all the enemies in the game
...
### Basecamps
File: *natives\stm\gamedesign\stage\basecamp\basecampmanagedata.user.3*

![](./attachments/Pasted%20image%2020241106232145.png)

## Armor
File: *natives\stm\gamedesign\stage\common\player/enummaker/armorseries.user.3*

155 armor series in total, idk how to interpret this number since it seems like alot

## Gestures
File: *natives\stm\gamedesign\stage\common\player/enummaker/huntercommtype.user.3*

![](./attachments/Pasted%20image%2020241106221741.png)

## Slinger ammos
File: *natives\stm\gamedesign\stage\common\player/enummaker/hunterslingerammotype.user.3*

![](./attachments/Pasted%20image%2020241106222038.png)

## Ammo Types
File: *natives\stm\gamedesign\stage\common\player/enummaker/wpgunshelltype.user.3*

![](./attachments/Pasted%20image%2020241106222452.png)

## Sharpness
File: *natives\stm\gamedesign\stage\common\player/enummaker/weaponkireajitype.user.3*

goes to purple

## Weapons
Files: *natives\stm\gamedesign\stage\common\player/enummaker/_insert_wp_name_id.user.3*
- Bows: 110 
- Charge Blade: 128
- Gun Lance: 129
- Hammer: 127
...
- SnS: 146
- Switch Axe: 129
- Long Sword (tachi?): 110
- Dual Blades: 137
- Whistle (HH): 137

## Dialogue
File: *natives/stm/gamedesign/dialogue/commondata/enummaker/dialogueid.user.3*

6949 Dialogues

## Facilities
File: *natives/stm/gamedesign/facility/enummaker/facilityid.user.3*

BARREL BOWLING WOO

MACA/MAKA Alchemy is just alchemy from like in previous games
